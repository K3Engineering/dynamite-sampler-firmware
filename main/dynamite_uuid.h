...
constexpr ble_uuid128_t CALIB_CFG_CHR_UUID128 = UUID128_FROM_STRING(CALIB_CFG_CHR_UUID);
constexpr ble_uuid128_t ADC_CONF_CHR_UUID128  = UUID128_FROM_STRING(ADC_CONF_CHR_UUID);
constexpr ble_uuid128_t ADC_DEBUG_CTRL_CHR_UUID128 = UUID128_FROM_STRING(ADC_DEBUG_CTRL_CHR_UUID);
