...
constexpr ble_uuid16_t DEVICE_MODEL_NUMBER_CHR_UUID16 =
    BLE_UUID16_INIT(DEVICE_MODEL_NUMBER_CHR_UUID);
constexpr ble_uuid16_t DEVICE_SERIAL_NUMBER_CHR_UUID16 =
    BLE_UUID16_INIT(DEVICE_SERIAL_NUMBER_CHR_UUID);
constexpr ble_uuid16_t DEVICE_HARDWARE_REV_CHR_UUID16 =
    BLE_UUID16_INIT(DEVICE_HARDWARE_REV_CHR_UUID);
...
constexpr ble_uuid128_t USER_KVS_CHR_UUID128 = UUID128_FROM_STRING(USER_KVS_CHR_UUID);
